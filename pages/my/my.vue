	...
	<view>
		<navigator url="../login/login">
			<view class="flex align-center p-2" hover-class="bg-light">
				<image src="/static/default.jpg" style="height: 100rpx;width: 100rpx;" class="rounded-circle"></image>
				<view class="flex flex-column flex-1 px-2">
					<text class="font-lg font-weight-bold">昵称</text>
					<text class="font text-muted">总帖子：10 今日发帖：0</text>
				</view>
		...
		<view class="px-3 py-2">
			<image src="/static/demo/banner1.jpg" mode="aspectFill" style="height: 170rpx; width: 100%;" class="rounded"></image>
		</view>
