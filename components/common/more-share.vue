<template>
	<uni-popup ref='popup' type="bottom">
		...
		<view class="flex align-center">
			<view v-for="(item,index) in providerList"  :key="index" :disabled="isDisableButton(item)" @tap="share(item)" hover-class="bg-light" class="flex-1 flex flex-column align-center justify-center py-2">
				<view :class="item.icon+' '+item.color" style="width: 100rpx;height: 100rpx;" class=" iconfont text-white flex align-center justify-center font-lg rounded-circle"></view>
